...
public class BackgroundIndexer implements AutoCloseable {
                        ...
                        while (!stop.get()) {
                            if (batch) {
                                ...
                                for (int i = 0; i < batchSize; i++) {
                                    ...
                                    insert.append(generateValues(id, threadRandom));
                                }
                                try {
                                ...
                                if (useAutoGeneratedIDs) {
                                    try {
                                        IndexResponse indexResponse = client.prepareIndex(index)
                                            .setTimeout(timeout).setSource(generateValues(id, threadRandom)).get();
    ...
    private String generateValues(long id, Random random) throws IOException {
